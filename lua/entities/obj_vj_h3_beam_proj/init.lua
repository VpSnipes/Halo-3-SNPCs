...
ENT.RadiusDamage = 12 -- How much damage should it deal? Remember this is a radius damage, therefore it will do less damage the farther away the entity is from its enemy
...
ENT.SoundTbl_Idle = {"halo3/cov/hunter/hunter_cannon/hunter_cannon_loop/hunter_cannon/loop.wav"}
ENT.SoundTbl_OnCollide = {"halo3/cov/weapons/fuel rod gun/explosion/fuelrod_explo1.wav", "halo3/cov/weapons/fuel rod gun/explosion/fuelrod_explo2.wav", "halo3/cov/weapons/fuel rod gun/explosion/fuelrod_explo3.wav"}
---------------------------------------------------------------------------------------------------------------------------------------------
...
function ENT:DeathEffects(data,phys)
	ParticleEffect("hcea_hunter_frnade_hit",self:GetPos(),Angle(0,0,0),nil)
